...
@Service
class UpdateDocumentInfoInfoService extends AbstractDocumentUpdateServiceBase<DocumentElementDtos.DocumentInfoUpdateDto> implements UpdateDocumentInfoUseCase {

    @Override
    @Transactional
    public Mono<Void> update(String documentId, DocumentElementDtos.DocumentInfoUpdateDto request) {
